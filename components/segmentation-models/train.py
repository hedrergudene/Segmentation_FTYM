...
def main(
    ...
    train_dts = ImageSegmentationDataset(
        os.path.join('./input', 'train'),
        train_idx,
        config_dct['train']['encoder_flag'],
        config_dct['train']['encoder_weights'],
        config_dct['train']['img_size'],
        len(idx2tag),
        is_train=True
    )
    ...
    val_dts = ImageSegmentationDataset(
        os.path.join('./input', 'val'),
        val_idx,
        config_dct['train']['encoder_flag'],
        config_dct['train']['encoder_weights'],
        config_dct['train']['img_size'],
    ...
    encoder_name=config_dct['train']['encoder_flag'],           # choose encoder, e.g. mobilenet_v2 or efficientnet-b7
    encoder_weights=config_dct['train']['encoder_weights'],     # use `imagenet` pre-trained weights for encoder initialization
